// https://github.com/limhenry/web-bluetooth-mi-scale/blob/06fe9dce1af4cb12d976ed1100ba9c815b1f0fe6/metrics.js#L3
...
export default class Metrics {
  ...
  getVisceralFat = () => {
    ...
    if (this.sex === "female") {
      ...
      vfal =
        (this.height * 0.143 - this.weight * subcalc) * -1 +
        this.age * 0.15 -
        5.0;
    }
  ...
  getBMI = () => {
    return this.checkValueOverflow(
  ...
  getFatPercentage = () => {
    ...
    let fatPercentage =
      (1.0 - ((LBM - value) * coefficient) / this.weight) * 100;
  ...
  getMuscleMass = () => {
    let muscleMass =
      this.weight -
      this.getFatPercentage() * 0.01 * this.weight -
      this.getBoneMass();
