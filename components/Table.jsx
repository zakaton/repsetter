...
export default function Table({filterTypes, orderTypes, numberOfResultsPerPage = 4, tableName, resultName, title, subtitle, CreateResultModal, DeleteResultModal}) {
  ...
  return (
    (
      <>
        ...
        {CreateResultModal && <CreateResultModal
        ...
        <div className="bg-white px-4 pt-6 sm:px-6 sm:pt-6">
          <div className="flex items-center pb-4">
            <div className="flex-auto">
              ...
              <p className="mt-1 text-sm text-gray-500">{subtitle || `View your ${resultName}s`}</p>
            </div>
            <div className="mt-0 flex-none">
            {CreateResultModal && <button
                type="button"
