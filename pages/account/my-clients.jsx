...
export default function AllUsers() {
  ...
  return (
    (
      <>
        <Head>
          <title>My Clients - Repsetter</title>
        </Head>
        <DeleteUserModal
        ...
        <div className="bg-white px-4 pt-6 sm:px-6 sm:pt-6">
          <div className="flex items-center pb-4">
            <div className="sm:flex-auto">
              ...
              <p className="mt-1 text-sm text-gray-500">View your Clients</p>
            </div>
              ...
              >
                <dl className="grid grid-cols-1 gap-x-4 gap-y-6 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
                  ...
                  <div className="sm:col-span-1">
                    ...
                    >
                      Delete<span className="sr-only"> subscription</span>
                    </button>
                  </div>
                </dl>
              </div>
