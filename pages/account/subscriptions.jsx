...
export default function Subscriptions() {
  ...
  const [isGettingNumberOfResults, setIsGettingNumberOfResults] = useState(false);
  ...
  useEffect(() => {
    if (results && !isGettingResults) {
      console.log(`update ${tableName}s!`);
      getResults(true);
    }
  }, [filters, order]);
    ...
    if (results) {
      ...
      const subscription = supabase
        ...
        .on('DELETE', (payload) => {
          ...
          // eslint-disable-next-line no-shadow
          setResults(results.filter((result) => result?.id !== deletedResult.id));
          getNumberOfResults();
        })
        .subscribe();
      return () => {
    ...
    (
      <>
        ...
        <CreateSubscriptionModal
          ...
          setCreateSubscriptionStatus={setCreateResultStatus}
          setShowDeleteSubscriptionNotification={setShowCreateResultNotification}
        />
        <Notification
        ...
        <DeleteSubscriptionModal
          ...
          selectedSubscription={selectedResult}
          setDeleteSubscriptionStatus={setDeleteResultStatus}
          setShowDeleteSubscriptionNotification={setShowDeleteResultNotification}
        />
        <Notification
        ...
        <div className="bg-white px-4 pt-6 sm:px-6 sm:pt-6">
          <div className="flex items-center pb-4">
            <div className="sm:flex-auto">
              ...
              <p className="mt-1 text-sm text-gray-500">View Subscriptions you&apos;ve created or redeemed</p>
            </div>
              ...
              >
                <dl className="grid grid-cols-1 gap-x-4 gap-y-6 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
                  ...
                  <div className="sm:col-span-1">
                    ...
                    >
                      Delete<span className="sr-only"> {resultName}</span>
                    </button>
                  </div>
                </dl>
              </div>
